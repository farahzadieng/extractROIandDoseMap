function [CT_Image,CT_Header,MaskData,roiList] = MaskStructures(CT,RS)
...
for i=1:roiCount
    ...
    for ContourDataIndex=1:NumberOfContourSeq
        ...
        for ContourPointNo=1:NumberOfContoursPoints
            ContourData_Voxels(ContourPointNo,1)=round((ContourData(3*ContourPointNo-2,1)-x0)/CT_Header.PixelSize);
            ContourData_Voxels(ContourPointNo,2)=round((ContourData(3*ContourPointNo-1,1)-y0)/CT_Header.PixelSize);
